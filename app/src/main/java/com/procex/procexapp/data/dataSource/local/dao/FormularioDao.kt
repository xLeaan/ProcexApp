...
interface FormularioDao {
    ...
    @Query("SELECT * FROM formulario WHERE estado = :estado")
    ...
    @Query("SELECT * FROM formulario WHERE tipo_documento = :tipo_documento AND num_documento = :num_documento")
    fun getFormularioByTypeAndNum(tipo_documento: String, num_documento: String): LiveData<FormularioEntity>
