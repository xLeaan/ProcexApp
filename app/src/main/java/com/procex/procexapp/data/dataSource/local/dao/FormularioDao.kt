...
interface FormularioDao {
    ...
    @Query("UPDATE formulario SET name_med = :name_med, name = :name, tipo_documento = :tipo_documento, num_documento = :num_documento, sexo = :sexo ,  RH = :RH, fecha = :fecha, telefono = :telefono, " +
