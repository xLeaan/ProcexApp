...
import com.procex.procexapp.presentation.screens.client.pendientes.components.ClientListoItem
...
fun ListoContent(
    ...
    LazyColumn(
        ...
        items(items = formulario) { formulario ->
            ClientListoItem(navController = navController, formulario = formulario)
        }
    }
}
